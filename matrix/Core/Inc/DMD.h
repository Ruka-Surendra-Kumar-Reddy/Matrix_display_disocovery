...
#define LIGHT_DMD_ROW_01_05_09_13()       {  HAL_GPIO_WritePin(GPIOA, B_Pin_Pin, GPIO_PIN_RESET); HAL_GPIO_WritePin(GPIOA, A_PIN_Pin, GPIO_PIN_RESET);  }
#define LIGHT_DMD_ROW_02_06_10_14()       { HAL_GPIO_WritePin(GPIOA, B_Pin_Pin, GPIO_PIN_RESET);HAL_GPIO_WritePin(GPIOA, A_PIN_Pin, GPIO_PIN_SET); }
#define LIGHT_DMD_ROW_03_07_11_15()       { HAL_GPIO_WritePin(GPIOA, B_Pin_Pin, GPIO_PIN_SET); HAL_GPIO_WritePin(GPIOA, A_PIN_Pin, GPIO_PIN_RESET); }
#define LIGHT_DMD_ROW_04_08_12_16()       {HAL_GPIO_WritePin(GPIOA, B_Pin_Pin, GPIO_PIN_SET);HAL_GPIO_WritePin(GPIOA, A_PIN_Pin, GPIO_PIN_SET);}
#define LATCH_DMD_SHIFT_REG_TO_OUTPUT()   {     HAL_GPIO_WritePin(GPIOA, sclk_pin_Pin, GPIO_PIN_SET);  HAL_GPIO_WritePin(GPIOA, sclk_pin_Pin, GPIO_PIN_RESET); }
#define OE_DMD_ROWS_OFF()                 {    HAL_GPIO_WritePin(GPIOA, OE_Pin_Pin, GPIO_PIN_RESET);}
#define OE_DMD_ROWS_ON()                  {    HAL_GPIO_WritePin(GPIOA, OE_Pin_Pin, GPIO_PIN_SET); }
